		...
		<div id="tableContainer">
			...
			<div id="elementContainer" class="column">
				<div class="mainContainer" id="browse">
					...
					<?print_r($arResult["SECTION"]["PROPERTIES"])?>
					<div class="secondCol col<?if(empty($arResult["PREVIEW_TEXT"]) && empty($arResult["SKU_OFFERS"]) && empty($arResult["PROPERTIES"])):?> hide<?endif;?>">
						<div class="brandImageWrap">
							<?if($arResult["SECTION"]["UF_SALE"]):?><?=$arResult["SECTION"]["UF_SALE"]?><?endif;?>
						</div>
				...
				<?if(!empty($arResult["DETAIL_TEXT"])):?>
					<div id="detailText">
						...
						<div class="changeDescription"><?=strip_tags($arResult["~DETAIL_TEXT"], '<table><tbody><tr><th><td></table><img><p><h2><h3><ul><li>')?></div>
					</div>
				<?endif;?>
				...
				<?if($arResult["SHOW_SIMILAR"] == "Y"):?>
		        	<div id="similar">
						...
						<?$similarFilter = array("IBLOCK_ID" => $arParams["IBLOCK_ID"], "!PROPERTY_OFFERS_VALUE" => "Снят с производства", "SECTION_ID" => $arResult["LAST_SECTION"]["ID"]);?>
						<?$APPLICATION->IncludeComponent(
	"dresscode:catalog.section", 
	"squares", 
	array(
