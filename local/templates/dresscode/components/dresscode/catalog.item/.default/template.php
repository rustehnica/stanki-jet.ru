						...
						<?if($arResult["EXTRA_SETTINGS"]["COUNT_PRICES"] > 1):?>
							<a class="price getPricesWindow" data-id="<?=$arResult["ID"]?>">
								...
								<s class="discount">
									...
									<?elseif($arResult["PROPERTIES"]["OLD_PRICE"]["VALUE"]):?>
										<?=CCurrencyLang::CurrencyFormat($arResult["PROPERTIES"]["OLD_PRICE"]["VALUE"], $arResult["EXTRA_SETTINGS"]["CURRENCY"], true)?>
									<?endif;?>
								</s>
							</a>
						<?else:?>
