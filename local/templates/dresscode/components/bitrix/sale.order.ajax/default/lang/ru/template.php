...
$MESS["SOA_ORDER_SUC1"] = "<p style='font-size:1.3rem;font-weight:bold;'>В ближайшее время с Вами свяжется менеджер для уточнения деталей заказа.</p><p style='font-size:1.3rem;font-weight:bold;'>Благодарим за обращение к официальному представителю ТМ JET.</p>";
