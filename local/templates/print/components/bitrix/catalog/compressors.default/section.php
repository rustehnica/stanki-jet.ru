...
if (!$APP->isAjax()) {
	...
	$res = CIBlockSection::GetList(Array(), Array("ID" => $arResult['SECTION_ID'], "IBLOCK_ID" => 43), false, Array('DESCRIPTION', "UF_REVIEW"));
	...
	echo '<span class="bigslidercatalog">';new bigSliderHelper();echo '</span>';
	...
	if($APPLICATION->GetCurPage() != "/catalog/" && $APPLICATION->GetCurPage() != "/catalog/derevoobrabatyvayushchie-stanki/" && $APPLICATION->GetCurPage() != "/catalog/obrabatyvayushchiye-tsentry/" && $APPLICATION->GetCurPage() != "/catalog/metalloobrabatyvayushchie-stanki/"){
