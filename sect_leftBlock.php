<div id="left">
	<a href="<?=SITE_DIR?>catalog/" class="heading orange<?$APPLICATION->ShowViewContent("menuRollClass");?>" id="catalogMenuHeading">Каталог станков JET <?=$_SESSION["SOTBIT_REGIONS"]["UF_MORPH"]?><ins></ins></a>
	<div class="collapsed">
	...
	<?/* if(stripos($APPLICATION->GetCurPage(), ".html") === false):?>
	<?$APPLICATION->IncludeComponent(
