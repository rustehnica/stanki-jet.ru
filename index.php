...
$APPLICATION->SetPageProperty("title", "JET-центр" . (!Regions::is_region() ? " Алтай" : "") . ": официальный поставщик станков, станочного оборудования и комплектующих JET".(Regions::is_region() ? " в ".Regions::get_name_case_region(5) : ""));
$APPLICATION->SetPageProperty("description", "Поставки и гарантийное обслуживание станков, комплектующих для станочного оборудования. Ремонт и гарантийное обслуживание. Диагностика. Каталог оборудования. Цены.".(Regions::is_region() ? " в ".Regions::get_name_case_region(5) : ""));
?>					
<?
	//include module
